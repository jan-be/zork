...
public class Held {
    ...
    public void kaempfe(Monster gegner) {
        if (gegner.leben > 0) {
            ...
            if (wert == 6) { // zork.Held verliert und wird schwer verletzt
                leben = leben - 64;
            } else if (wert >= 3) {
                leben = leben - gegner.angriff;
            } else {
                gold += wuerfel.nextInt(20);    // zork.Held gewinnt haushoch
            }
            if(gegner.leben < 0) {
                monsterGetoetet++;
            }
    ...
    public void paint(Graphics g) {
        ...
        g.setColor(new Color(0, (int) leben/10, 0));
        ...
        g.drawString("zork.Held: Leben: " + leben + ", Angriff: " + angriff + ", Rüstung: " + ruestung + ", Gold: " + gold,
                124, 60 + dd.hoehe * 20);
    }
